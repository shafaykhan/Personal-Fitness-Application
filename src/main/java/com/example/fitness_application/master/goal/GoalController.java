...
public class GoalController {
  ...
  @PostMapping
  public ResponseEntity<GoalDTO> saveOrUpdate(@Valid @RequestBody GoalDTO payloadDTO) {
    return ResponseEntity.ok(service.saveOrUpdate(payloadDTO));
  }

  @GetMapping("/by-user/{userId}")
  public ResponseEntity<List<GoalDTO>> findAllByUserId(@Valid @PathVariable Long userId) {
